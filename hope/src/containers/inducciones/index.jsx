...
const InduccionesContainer = () => {
    ...
    const fetchList = async () => {
        try {
            ...
            setRows([]);
            setMensaje("Error al cargar las inducciones");
        }
    };
    ...
    const toggleEstado = async (row, nuevo) => {
        try {
            await axios.put(`${API}/inducciones/${row.idinduccion}/`, {
                ...row,
                estado: nuevo,
                idusuario: row.idusuario ?? 1
            });
                    ...
                    <div style={{ maxWidth: 900, margin: "0 auto" }}>
                        ...
                        <div style={tableWrap}>
                            ...
                            <table style={tbl}>
                                <thead>
                                    <tr>
                                        {["Inicio", "Fin", "Estado", "Acciones"].map(h => (
                                            <th key={h} style={th}>
                                                {h}
                                            </th>
                                        ))}
...
const msg = m => ({
    textAlign: "center",
    color: m.includes("Error") ? "red" : "green",
    marginBottom: 20,
    fontWeight: "bold"
});
