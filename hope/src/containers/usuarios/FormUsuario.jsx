  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} style={{ flex: 1 }}>
              ...
              {!cambiarContrasena ? (
                ...
                <div style={{ position: "relative" }}>
                  <input
                    ...
                    required
                    style={{ width: "100%", padding: "10px 40px 10px 10px", border: "1px solid #ccc", borderRadius: "6px" }}
                  />
                  <button
                    type="button"
        ...
        {/* Empleado */}
        <div style={{ marginBottom: "15px" }}>
          <label htmlFor="empleado" style={{ display: "block", marginBottom: "8px" }}>Empleado</label>
          <input
            type="text"
