              ...
              <td style={{ padding: "10px", textAlign: "center", borderBottom: "1px solid #f0f0f0" }}>
                <button
                  ...
                  style={{
                    ...
                    width: "110px",
                    padding: "6px 14px",
                    background: u.estado && u.idusuario !== idUsuarioLogueado ? "#fb8500" : "#6c757d",
                    color: "#fff",
                    border: "none",
                    borderRadius: "5px",
                ...
                {u.estado ? (
                  <button
                    ...
                    style={{
                      ...
                      width: "110px",
                      padding: "6px 14px",
                      background: u.idusuario !== idUsuarioLogueado ? "#fb8500" : "#6c757d",
                      color: "#fff",
                      border: "none",
                      borderRadius: "5px",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      width: "110px",
                      padding: "6px 14px",
                      background: u.idusuario !== idUsuarioLogueado ? "#ffb703" : "#6c757d",
                      color: "#fff",
                      border: "none",
                      borderRadius: "5px",
                      cursor: u.idusuario !== idUsuarioLogueado ? "pointer" : "not-allowed",
