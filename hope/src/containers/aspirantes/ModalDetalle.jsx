...
const ModalDetalle = ({ aspirante, onClose, idiomas = [], pueblos = [], convocatorias = [] }) => {
  ...
  const convocatoriasActivas = convocatorias.filter((c) => c.estado === true);
                      ...
                      return (
                        <tr key={p.idpostulacion}>
                          ...
                          <td
                            style={{
                              ...tdStyle,
                              color: convocatoria.estado ? "green" : "red",
                              fontWeight: 600,
                            }}
                          >
                            {estadoConv}
