            ...
            <div className="inner">
                ...
                <div className="offcanvas-head mb-3">
                    <div className="header-top-offcanvas">
                        <p>
                            <i className="icofont-google-map"></i> <span>ADDRESS:</span> 568 Elizaberth Str, London, UK
                        </p>
                    </div>
                </div>
                <nav className="offcanvas-menu">
                    <ul>
                        <li>
                            ...
                            <span className="menu-expand" onClick={onClickHandler} aria-hidden="true"></span>
                        ...
                        <li>
                            ...
                            <ul className="offcanvas-submenu">
                                ...
                                <li>
                                    <NavLink to={process.env.PUBLIC_URL + "/service-detalis"}>service details</NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul className="offcanvas-submenu">
                                <li>
                                    <NavLink to={process.env.PUBLIC_URL + "/blog"}>Blog list</NavLink>
                                </li>
                                <li>
                ...
                <div className="offcanvas-social my-4">
                    <ul>
                        ...
                        <li>
                            <SocialIcon path="https://www.facebook.com/" icon="icofont-facebook" />
                        </li>
                        <li>
                            <SocialIcon path="https://www.instagram.com/" icon="icofont-instagram" />
                        </li>
                        <li>
                            <SocialIcon path="https://rss.com/" icon="icofont-rss-feed" />
                        </li>
                        <li>
                            <SocialIcon path="https://www.youtube.com/" icon="icofont-play-alt-1" />
                        </li>
                    </ul>
                </div>
