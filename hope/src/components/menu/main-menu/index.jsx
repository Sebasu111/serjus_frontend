...
import { 
  FaHome, FaUsers, FaUserTie, FaClipboardList, FaBook, FaFileAlt, FaSignOutAlt
} from "react-icons/fa";
  ...
  return (
    <nav className="sidebar-menu">
      ...
      <ul className="sidebar-menu-list">
        ...
        {/* Personal */}
        <li>
          <div className="sidebar-menu-link" onClick={() => toggleSubmenu("personal")}>
        ...
        {/* Reclutamiento */}
        <li>
          <div className="sidebar-menu-link" onClick={() => toggleSubmenu("reclutamiento")}>
        ...
        {/* Integración */}
        <li>
          <div className="sidebar-menu-link" onClick={() => toggleSubmenu("integracion")}>
        ...
        {/* Desempeño */}
        <li>
          <div className="sidebar-menu-link" onClick={() => toggleSubmenu("desempeno")}>
        ...
        <li>
          <div className="sidebar-menu-link" onClick={() => toggleSubmenu("disciplinario")}>
            <FaUserTie className="menu-icon" /> Control Disciplinario
          </div>
        ...
        {/* Catálogo */}
        <li>
          <div className="sidebar-menu-link" onClick={() => toggleSubmenu("catalogo")}>
          ...
          {openMenu === "catalogo" && (
            <ul className="sidebar-submenu">
              ...
              <li><NavLink to={`${base}/Idioma`} className="sidebar-submenu-link">Idioma</NavLink></li>
        ...
        {/* Informes */}
        <li>
          <NavLink to={`${base}/Informes`} className="sidebar-menu-link">
        ...
        {/* Documentos */}
        <li>
          <NavLink to={`${base}/Documentos`} className="sidebar-menu-link">
        ...
        {/* Cerrar Sesión */}
        <li>
          <NavLink to={`${base}/`} className="sidebar-menu-link logout-link">
