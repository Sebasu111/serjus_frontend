                    ...
                    <div style={{ maxWidth: "900px", margin: "0 auto" }}>
                        ...
                        <div style={{ background: "#fff", padding: "40px", borderRadius: "12px", boxShadow: "0 4px 20px rgba(0,0,0,0.1)", marginBottom: "40px" }}>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div style={{ marginBottom: "20px" }}>
                                    <input type="checkbox" checked={estadoActivo} onChange={(e) => setEstadoActivo(e.target.checked)} /> Activo
                                </div>

                                <button
                                    type="submit"
                                    style={{ width: "100%", padding: "12px", background: "#007bff", color: "#fff", border: "none", borderRadius: "8px", fontWeight: "bold", cursor: "pointer" }}
                                >
                        ...
                        {/* --- TABLA --- */}
                        <div style={{ background: "#fff", borderRadius: "12px", padding: "20px 30px", boxShadow: "0 4px 20px rgba(0,0,0,0.08)", maxHeight: "600px", overflowY: "auto" }}>
                            <h3 style={{ marginBottom: "20px", textAlign: "center" }}>Evaluaciones por Criterio Registradas</h3>
                            <table style={{ width: "100%", borderCollapse: "collapse" }}>
                                <thead>
                                    <tr>
                                        <th style={{ borderBottom: "2px solid #eee", padding: "10px" }}>Evaluación</th>
                                        <th style={{ borderBottom: "2px solid #eee", padding: "10px" }}>Criterio</th>
                                        <th style={{ borderBottom: "2px solid #eee", padding: "10px" }}>Puntaje</th>
                                    ...
                                    {evaluaciones.length > 0 ? (
                                        evaluaciones.map((e) => (
                                            <tr key={e.idevaluacioncriterio}>
                                                <td style={{ padding: "10px", borderBottom: "1px solid #f0f0f0" }}>{e.idevaluacion || "N/A"}</td>
                                                <td style={{ padding: "10px", borderBottom: "1px solid #f0f0f0" }}>{e.idcriterioevaluacion || "N/A"}</td>
                                                <td style={{ padding: "10px", borderBottom: "1px solid #f0f0f0" }}>{e.puntajecriterio}</td>
                                                <td style={{ padding: "10px", textAlign: "center", color: e.estado ? "green" : "red", fontWeight: "600" }}>{e.estado ? "Activo" : "Inactivo"}</td>
                                                <td style={{ padding: "10px", textAlign: "center" }}>
                                                    <button onClick={() => handleEdit(e)} style={{ padding: "6px 14px", background: "#ffc107", color: "#fff", border: "none", borderRadius: "5px", marginRight: "6px", cursor: "pointer" }}>Editar</button>
                                                    {e.estado ? (
                                                        <button onClick={() => handleDelete(e.idevaluacioncriterio)} style={{ padding: "6px 14px", background: "#dc3545", color: "#fff", border: "none", borderRadius: "5px", cursor: "pointer" }}>Desactivar</button>
                                                    ) : (
                                                        <button onClick={() => handleActivate(e.idevaluacioncriterio)} style={{ padding: "6px 14px", background: "#28a745", color: "#fff", border: "none", borderRadius: "5px", cursor: "pointer" }}>Activar</button>
                                                    )}
                                                </td>
                                            </tr>
                                        ))
                                        ...
                                        <tr>
                                            <td colSpan="5" style={{ textAlign: "center", padding: "20px" }}>No hay evaluaciones registradas</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
