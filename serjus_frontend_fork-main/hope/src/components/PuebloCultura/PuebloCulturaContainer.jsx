    ...
    const fetchPueblos = async () => {
        try {
            const res = await axios.get(
                "http://127.0.0.1:8000/api/pueblocultura/"
            );
                            ...
                            <form onSubmit={handleSubmit}>
                                <div style={{ marginBottom: "20px" }}>
                                    ...
                                    <input
                                        ...
                                        value={nombrePueblo}
                                        onChange={(e) =>
                                            setNombrePueblo(e.target.value)
                                        }
                                        required
                                        style={{
                                            width: "100%",
